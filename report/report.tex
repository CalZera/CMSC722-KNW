...
%% TODO what is Pyhop
PyHOP is a hierarchical task network (HTN) written in Python. The idea for HTN is that for some planning problems, we may have some recipes to look for solutions. The recipe helps us decompose the problem in to tasks and subtasks.
%% TODO what is SePRE
...
We have implemented SePRE for Pyhop.
